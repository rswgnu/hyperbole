...
;; Last-Mod:      7-Jan-23 at 23:50:59 by Mats Lidell
;;
...
(defvar hbut--inhibit-something nil)
...
associated arguments from the button."
  (when (and ibut-type-symbol (symbolp ibut-type-symbol))
	...
	(let ((types (htype:category 'ibtypes)) ;FIXME: Unused?
