...
# Last-Mod:     20-Aug-22 at 23:04:48 by Mats Lidell
#
...
EL_COMPILE = hact.el hactypes.el hargs.el hbdata.el hbmap.el hbut.el \
	     ...
	     hui-dired-sidebar.el hypb-maintenance.el hui-em-but.el hypb-register.el
...
ELC_COMPILE =  hactypes.elc hibtypes.elc hib-debbugs.elc hib-doc-id.elc hib-kbd.elc \
	     ...
	     set.elc hypb-ert.elc hui-dired-sidebar.elc hypb-maintenance.elc hypb-register.elc
