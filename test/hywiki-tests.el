...
;; Last-Mod:     24-Nov-24 at 00:33:43 by Mats Lidell
;;
  ...
  (let ((hywiki-directory (make-temp-file "hywiki" t)))
    (unwind-protect
        (progn
          ...
          ;; (with-temp-buffer
          ;;   (hywiki-mode)
          ;;   (insert "WikiWord#\"section with space within quotes\"")
          ;;   (goto-char 4)
          ;;   (should (string= "WikiWord#\"section with space within quotes\"" (hywiki-word-at))))
